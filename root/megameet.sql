...
DROP TABLE IF EXISTS booked, cart, events, user_info;
...
CREATE TABLE events (
    ...
    event_img4 VARCHAR(255) DEFAULT NULL,
    event_img5 VARCHAR(255) DEFAULT NULL
);
...
ALTER TABLE booked
    ADD CONSTRAINT fk_booked_event FOREIGN KEY (event_id) REFERENCES events (event_id) ON DELETE CASCADE ON UPDATE CASCADE,
    ADD CONSTRAINT fk_booked_user FOREIGN KEY (id) REFERENCES user_info (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE cart
    ADD CONSTRAINT fk_cart_user FOREIGN KEY (id) REFERENCES user_info (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE events
    ADD CONSTRAINT fk_events_user FOREIGN KEY (id) REFERENCES user_info (id) ON DELETE CASCADE ON UPDATE CASCADE;
