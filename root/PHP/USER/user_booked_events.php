...
$select_table = " SELECT `ticket_number`, `event_id` FROM `booked` WHERE `id` = '$user_id'";
...
<head>
  ...
  <title>User booked Events</title>
      ...
      <div class='organizedEvent_table'>
        <table style='border-collapse: collapse; border:black solid 1px;'>
          ...
          <tr>
            ...
            <td>
            <a href='../../PHP/removebooking.php?ticket_number=$ticket_number'>
